...
Page({
  ...
  // address, latitude, longitude, message, contact, type(sell, buy), openid
  ...
  async handleButtonTap() {
    ...
    let result = await http('https://ik9hkddr.qcloud.la/index.php/trade/add_item', 'POST', this.setData)
